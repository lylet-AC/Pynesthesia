...
class Game:
    def __init__(self):
        ...
        self.load_data()
        self.set_current_map(self.first_map)

    def load_data(self):
        self.first_map = pickle.load(open(os.path.join(LEVELS_FOLDER, "first.p"), "rb"))
        ...
        self.barre_img = pg.image.load(os.path.join(SPRITE_FOLDER, "barrel.png"))
        self.barre_img = pg.transform.scale(self.barre_img, (TILE_SIZE, TILE_SIZE))
