...
class Game:
    def __init__(self):
        ...
        self.load_data()
        self.set_current_map(self.level1_map)

    def load_data(self):
        # load the map data
        self.level1_map = pickle.load(open(os.path.join(LEVELS_FOLDER, "level1.p"), "rb"))
        self.test_map = pickle.load(open(os.path.join(LEVELS_FOLDER, "test.p"), "rb"))
